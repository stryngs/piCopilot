...
#         raspivid -n -fl -w $1 -h $2 -b 10000000 -fps 30 -t 0 -rot 180 --exposure auto -o - | gst-launch-1.0 -v fdsrc ! h264parse ! rtph264pay config-interval=10 pt=96 ! udpsink host=$3 port=5600
